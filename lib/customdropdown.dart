...
const EdgeInsets _kMenuItemPadding = const EdgeInsets.symmetric(horizontal: 15.0);
const EdgeInsetsGeometry _kAlignedButtonPadding = const EdgeInsetsDirectional.only(start: 0.0, end: 10.0);
const EdgeInsets _kUnalignedButtonPadding = EdgeInsets.zero;
const EdgeInsets _kAlignedMenuMargin = EdgeInsets.zero;
const EdgeInsetsGeometry _kUnalignedMenuMargin = const EdgeInsetsDirectional.only(start: 0.0, end: 10.0);
...
class CustomDropdownButton<T> extends StatefulWidget {
  ...
  CustomDropdownButton({
    ...
    this.isDense: false,
       ...
       assert(value == null || items.where((CustomDropdownMenuItem<T> item) => item.value == value).length == 1),
      super(key: key);
